...
public static class TestData
{
    ...
    public static readonly DateTimeOffset InitialNow = new DateTime(
        2015,
        12,
        4,
        0,
    ...
    public static readonly DateTimeOffset StartsAt = new DateTime(
        2016,
        1,
        1,
        0,
    ...
    public static readonly DateTimeOffset EndsAt = new DateTime(
        2016,
        2,
        1,
        0,
    ...
    public static Amount Sek(long a) => new(Value: a, Currency: CurrencyCode.SEK);
    ...
    public static Bid Bid1 =>
        new(User: Buyer1, Amount: Amount.Parse("SEK10"), At: StartsAt.AddHours(1.0));

    public static Bid Bid2 =>
        new(User: Buyer2, Amount: Amount.Parse("SEK12"), At: StartsAt.AddHours(2.0));

    public static T WithBids<T>(T state)
        where T : IState
    {
